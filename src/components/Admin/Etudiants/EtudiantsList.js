              ...
              {data.length > 0 ? (
                data
                  ...
                  .map((etudiant, index) => (
                    <tr
                      key={etudiant._id}
                      style={etudiant.index % 2 === 0 ? styles.tbodyTrEven : {}}
                    >
                      <td style={styles.td}>{etudiant.nom}</td>
                      <td style={styles.td}>{etudiant.prenom}</td>

                      <td style={styles.td}>{etudiant.email}</td>
                      <td style={styles.td}>{etudiant.telephone}</td>
                      <td style={styles.td}>{etudiant.universite}</td>
                      <td style={styles.td} className="text-center">
                        <button
                          ...
                          onClick={() => handleDeleteWithSwal(etudiant._id)}
                        >
